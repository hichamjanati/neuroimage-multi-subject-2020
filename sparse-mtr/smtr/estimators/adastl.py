...
from .solvers import solver_adastl
from ..utils import inspector_lasso


class AdaSTL(BaseEstimator):
    ...
    def fit(self, X, Y, **kwargs):
        ...
        **kwargs: supplementary parameters passed to the solver. See
        ...
        self.coefs_, self.loss = self._solver(X, Y, alpha=self.alpha,
    ...
    def get_params_grid(self, X, Y, cv_size=50, eps=0.01):
        X, Y = self._pre_fit(X, Y)
        n_samples = X.shape[1]
